...
const additionalIndices = {
  ...
  '/community-and-contribution/community-resources': [
    'figma, mural, react, wordpress, eleventy, jinja, nhs app'
  ],
  ...
  '/design-system/components/panel': ['confirmation, success, interruption'],
  '/design-system/components/radios': ['radio buttons, option buttons'],
  '/design-system/components/search': ['searchbar, searchbox, search field'],
  '/design-system/components/section-navigation': [
    'secondary navigation, sub-navigation, side navigation, tabbed navigation, vertical navigation, horizontal navigation, tabs, tab navigation'
  ],
  ...
  '/design-system/patterns/help-users-decide-when-and-where-to-get-care': [
    'non-urgent care card, blue care card, red care card, urgent care card, emergency care card'
  ],
  ...
  '/design-system/styles/typography': ['fonts, typeface, type, typefaces'],
