...
describe('Nunjucks params helper', () => {
  describe('Component directories from NHS.UK frontend', () => {
    it.each([
      ...
      expect(getNunjucksParams(component)).toEqual(expect.arrayContaining([
...
describe('Nunjucks path helper', () => {
  it('should return Nunjucks path for an example', () => {
    expect(getNunjucksPath({ group: 'components', item: 'buttons', type: 'default' })).toBe(
      join(config.sourcePath, 'views/design-system/components/buttons/default/index.njk'),
    );

    expect(getNunjucksPath({ group: 'components', item: 'buttons', type: 'secondary' })).toBe(
      join(config.sourcePath, 'views/design-system/components/buttons/secondary/index.njk'),
    );

    expect(getNunjucksPath({ group: 'components', item: 'buttons', type: 'reverse' })).toBe(
      join(config.sourcePath, 'views/design-system/components/buttons/reverse/index.njk'),
    );
  });
});
