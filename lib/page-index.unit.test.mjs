...
test('init', async () => {
  ...
  jest.mocked(axios.get).mockResolvedValue(returnData)

  jest.mocked(axios.all).mockResolvedValue(allUrls)
 ...
 * @import { PageDoc } from './page-index.js'
 */
