...
class PageIndex {
  ...
  async init() {
    ...
    try {
      ...
      links.each((_, el) => {
        ...
        if (href && !indexBlacklist.includes(href)) {
   ...
   *
   * @param {string} [query] - Query from 'q' param
   ...
   *
   * @param {Pick<Index.Result, 'ref'>} result - Search result
 ...
 * @property {string | string[]} h2 - Page heading 2
 * @property {string | string[]} h3 - Page heading 3
